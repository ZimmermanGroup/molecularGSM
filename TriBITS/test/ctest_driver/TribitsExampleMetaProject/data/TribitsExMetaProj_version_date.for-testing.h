/* TRIBITSEXMETAPROJ_VERSION_DATE
 *
 * This macro gives the version date of the TribitsExMetaProj git repository at
 ...
 * the version of TribitsExMetaProj being used and allows
 * TRIBITSEXMETAPROJ_VERSION_DATE to be used in C/C++ ifdefs like:
 *
 * #if defined(TRIBITSEXMETAPROJ_VERSION_DATE) && TRIBITSEXMETAPROJ_VERSION_DATE >= 2019032704
 ...
 * TribitsExMetaProj at configure and build time to adjust for the addition of
...
#define TRIBITSEXMETAPROJ_VERSION_DATE 2021091421
